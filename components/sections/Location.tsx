...
import { X, CheckCircle2, Calendar, Compass } from "lucide-react";
...
export default function Location() {
  ...
  const fireConversionEvent = () => {
    if (typeof window !== "undefined" && (window as any).gtag) {
      ...
      console.log("🎯 Location Section Google Conversion event logged successfully.");
    }
  };
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col p-6 sm:p-8 space-y-6">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 pb-4">
              ...
              <button 
                ...
                className="p-1 rounded-md text-gray-400 hover:text-gray-900 hover:bg-gray-100 transition-colors focus:outline-none flex-shrink-0"
              ...
              <div className="flex flex-col items-center justify-center text-center py-10 space-y-4 animate-scale-up">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-gray-500 max-w-xs leading-relaxed font-medium">
                    Thank you for your interest. Your request for {modalContext} has been logged successfully. An executive manager will contact you shortly to share location routing parameters and site visit configurations.
                  </p>
                </div>
                <button
                  onClick={closeFormModal}
