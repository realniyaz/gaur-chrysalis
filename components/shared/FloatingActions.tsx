...
export default function FloatingActions() {
  ...
  const projectKnowledge: Record<string, string> = {
    ...
    pricing: "Our pricing structure starts From ₹ 1.39 Cr*, for spacious 3 BHK models (Super Area: 1625 Sq. Ft.). Exact pricing metrics for 4 BHK model ((Super Area: 1960 Sq. Ft.)).",
